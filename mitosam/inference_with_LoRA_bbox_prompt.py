...
METRICS_CSV_PATH = EXPERIMENT_REPORT_DIR / "inference_metrics.csv"
...
if VISUALIZE_IDX is not None:
    ...
    axes[0].set_title("Input image + prompt" , fontsize=14)
    axes[0].axis("off")
    ...
    out_path = VISUALIZATION_DIR / f"val_sample_{VISUALIZE_IDX:03d}.png"
